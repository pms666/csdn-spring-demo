...
<body>
	<div class="x-body">
		...
		action="${pageContext.request.contextPath}/home/modifyHomeHou.do"	method="post" enctype="multipart/form-data">
			<div class="layui-form-item">
				<label for="link" class="layui-form-label"> <span
					class="x-red">*</span>序号
				</label>
				<div class="layui-input-inline">
					<input type="text" id="link" name="${home.id}" required
	...
	<!-- <script>
		layui.use([ 'form', 'layer', 'upload' ], function() {
			...
			//图片上传接口
			layui.upload({
				url : '${pageContext.request.contextPath}/upload.json' //上传接口
				,
